document.addEventListener("DOMContentLoaded" , async ()=> {
    ...
    function prepareWrapperDivForCartItem(product, productQuantityMapping){
        ...
        orderDetailsProduct.classList.add("order-details-product" ,"d-flex", "flex-row");
         ...
         const quantityLable = document.createElement("div");
         quantityLable.textContent = 'Quantity';
         quantityLable.classList.add("fw-blod");
         ...
         orderDetailsProductQuantity.appendChild(quantityLable);
    ...
    async function populateCart() {
        ...
        products.forEach(product => {
            prepareWrapperDivForCartItem(product, productQuantityMapping);
